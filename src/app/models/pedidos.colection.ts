...
export let Pedidos: Pedido[] = [new Pedido(2, new Date(2020, 0O5, 0O5, 20, 30), 1, [1,2]), new Pedido(4, new Date(2020, 0O5, 0O5, 20, 55), 2, [5])];
...
Pedidos[1].getDetalleNumero(0).preparar(new Date(2020, 0O5, 0O5, 21, 12));
